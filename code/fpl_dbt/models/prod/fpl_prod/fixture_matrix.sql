...
FROM fixture_data f
LEFT JOIN team_info t ON f.team_id = t.team_id
LEFT JOIN team_info t1 ON f.opp_1 = t1.team_id
LEFT JOIN team_info t2 ON f.opp_2 = t2.team_id
LEFT JOIN team_info t3 ON f.opp_3 = t3.team_id
LEFT JOIN team_info t4 ON f.opp_4 = t4.team_id
LEFT JOIN team_info t5 ON f.opp_5 = t5.team_id